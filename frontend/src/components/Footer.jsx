  ...
  return (
    <>
      <footer className="border py-10">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-20 py-3 ">
      ...
      <div className=" container mx-auto  flex flex-col md:flex-row justify-between items-center px-20 py-3">
        ...
        <div className="mt-4 md:mt-0 flex space-x-4">
          ...
          <a href="https://www.linkedin.com/in/sandip-pal-7877b9285/">
